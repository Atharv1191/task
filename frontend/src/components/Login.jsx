...
const Login = ({ onSubmit, onSwitchMode }) => {
  ...
  const url = "https://task-backend-virid.vercel.app"

  useEffect(() => {
    const checkSession = async () => {
      if (localStorage.getItem('currentUser')) return  // ← already logged in
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // token localStorage mein save karo — mobile ke liye
